...
<body>
    <?php 
     ...
     <h2 class="display-5 text-primary"><b>Teacher</b> </h2>
     <div class=" text-end"><a href="./teacher-add.php" class="btn btn-primary">Add New Teacher</a></div>
