...
if (isset($_SESSION['admin_id']) && 
    ...
    if ($_SESSION['role'] == 'Admin') {
      if (isset($_GET['searchKey'])) {
       ...
       $requisition = searchRequisition($search_key,$conn);
...
<body>
    <?php 
     ...
     <h2 class="display-5 text-danger">All Requisition</h2>
              ...
              <table class="table table-bordered mt-3 table-striped table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="requisition-details.php?r_id=<?=$req['r_id']?>"
                           class="btn btn-warning">Details</a>
                        <a href="requisition-delete.php?r_id=<?=$req['r_id']?>"
