...
if (
  ...
  if ($_SESSION['role'] == 'Admin') {
    ...
    include "./transport/AllFunction.php";
    ...
    <head>
      ...
      <title>Admin - Transport Schedule</title>
      ...
      include "inc/navbar.php";?>
        ...
        <div class="container mt-4">
            ...
            <div class="col-3 text-right"> 
              <div class="p-3"><a href="./transport-add-special-campus.php" class="btn btn-dark">New Transport
                  Schedule Add </a></div>
            </div>
            ...
            <tbody>
              ...
              foreach ($transport_special_campus as $t3) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="./transport/edit-delete/edit_special_campus_town.php?ID=<?= $t3['ID'] ?>"
                      class="btn btn-warning">Edit</a>
                    <a href="./transport/edit-delete/delete_special_campus_town.php?ID=<?= $t3['ID'] ?>"
