    ...
    if ($_SESSION['role'] == 'Admin') {
        ...
        isset($_POST['address'])){
         ...
         if (empty($fname)) {
             ...
             header("Location: ../teacher-addr.php?error=$em&$data");
             exit;
             ...
             header("Location: ../teacher-add.php?success=New Teacher account has been created successfully");
             exit;
         }
     
     
     }else {
         header("Location: ../teacher-add.php?error=error");
         exit;
     }
}else {
